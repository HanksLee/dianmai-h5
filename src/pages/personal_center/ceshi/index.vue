...
<template>
  ...
  <div>
    ...
    <div class="image-item space" @click="showActionSheet()">
      <div class="image-up" style="color: white">ssssssssssssss</div>
    </div>
      ...
      <div class="upload_warp_img">
        <div class="upload_warp_img_div" v-for="(item,index) in imgList" :key="index">
          <div class="upload_warp_img_div_top">
            <img src="/static/img/closeimg.png" class="upload_warp_img_div_del" @click="fileDel(index)">
          </div>
        ...
        <div class="upload_warp_left" id="upload_warp_left" @click="fileClick()" v-if="this.imgList.length < 6">
          ...
          <img src="/static/img/closeimg.png" class="imgs"/>
        </div>
      </div>
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods:{
      ...
      fileChange(el) {
        this.files=document.getElementById("upload_file").files[0];
